...
CODE = r'''"""provider_router.py - free/local provider cascade for Agent Router.
...
pathlib.Path("provider_router.py").write_text(CODE, encoding="utf-8")
print("Wrote provider_router.py")